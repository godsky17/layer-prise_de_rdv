        ...
        <div class="lg-inner-column">
            <div class="left-column relative z-[1]">
                <div class="max-w-[520px] pt-20 ltr:pl-20 rtl:pr-20">
                    <a href="index.html">
                        <img src="{{ asset('admin/assets/images/logo/logo.svg') }}" alt=""
                            class="mb-10 dark_logo">
                        <img src="{{ asset('admin/assets/images/logo/logo-white.svg') }}" alt=""
                ...
                <div class="absolute left-0 2xl:bottom-[-160px] bottom-[-130px] h-full w-full z-[-1]">
                    <img src="{{ asset('admin/assets/images/auth/ils1.svg') }}" alt=""
            ...
            <div class="right-column  relative">
                <div class="inner-content h-full flex flex-col bg-white dark:bg-slate-800">
                    <div class="auth-box h-full flex flex-col justify-center">
                        ...
                        <form class="space-y-4" method="POST" action='{{ route('auth.doLogin') }}'>
                          @csrf
                            <div class="fromGroup">
                                <label class="block capitalize form-label">email</label>
                                <div class="relative ">
                                    <input type="email" name="email" class="  form-control py-2"
                                        placeholder="Add placeholder" value="{{old('email')}}">
                                    @error('email')
                                        {{ $message}}
                                    @enderror
                                </div>
